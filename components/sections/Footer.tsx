...
export default function Footer() {
  ...
  const footerLinks = {
    courses: [
      { name: 'Ethical Hacking', href: '/courses', icon: '💀' },
      { name: 'Penetration Testing', href: '/courses', icon: '⚔️' },
      { name: 'Web Security', href: '/courses', icon: '🕷️' },
      { name: 'Network Security', href: '/courses', icon: '🌐' },
      { name: 'Cloud Security', href: '/courses', icon: '☁️' },
    ],
    company: [
      { name: 'About Us', href: '/about', icon: '🎯' },
      { name: 'Careers', href: '/about', icon: '💼' },
    ...
    legal: [
      ...
      { name: 'Refund Policy', href: '/terms', icon: '💰' },
      { name: 'Cookie Policy', href: '/privacy', icon: '🍪' },
    ],
  };
        ...
        <div className="border-t border-green-500/20 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
            <p className="text-gray-500 font-mono">
              <span className="text-green-500">$</span> © {currentYear} CyberAcademy. All rights reserved.
            </p>
